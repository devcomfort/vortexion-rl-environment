...
# Pyxel 앱을 패키징하여 실행 가능한 .pyxapp 파일 생성
build:
    @echo "Building executable Pyxel app..."
    ...
    @echo "Created src.pyxapp - executable Pyxel app"

# Pyxel 앱을 단일 HTML 파일로 변환 (웹 배포용)
# 참고 정보:
